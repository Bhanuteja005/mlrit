...
function About() {
    ...
    return (
      <div className="py-12 bg-gray-900">
        ...
        <h1 className="text-5xl sm:text-1xl md:text-6xl text-teal-600 mt-20 md:mt-0 font-bold bg-clip-text">About Us</h1>
  <TextGenerateEffect words={words} className="mt-4 font-normal text-base md:text-lg sm:text-sm text-neutral-300 max-w-full mx-auto text-left pl-5 pr-5"/>
</div>
</div>
